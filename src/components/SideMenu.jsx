...
import { getBrands, getCategories, filterCategories, filterBrands } from "../redux/actions/index";
        ...
        <div className={S.categoryContainer}>
          ...
          <div className={S.filterContainer}>
            ...
            <div className={S.select}>
              <select name="Filter" type='option' onChange={(e) => handleOnChangeCat(e)}>
            ...
            <div className={S.select}>
            <select name="Filter" type='option' onChange={(e) => handleOnChangeBrand(e)}>
