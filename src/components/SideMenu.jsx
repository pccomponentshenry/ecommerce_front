        ...
        <div className={S.categoryContainer}>
          ...
          <div className={S.filterContainer}>
            ...
            <div className={S.sharedInput}>
              ...
              <input key='min_price' id='min' type='text' name='min_price' placeholder='Min'
                onBlur={handlePriceChange} className={S.inputSmall} />
              <input key='max_price' id='max' type='text' name='max_price' placeholder='Max'
                onBlur={handlePriceChange} className={`${S.inputSmall} ${S.inputRight}`} />
              <button className={S.button} onClick={handlePriceSubmit}>&#8680;</button>
